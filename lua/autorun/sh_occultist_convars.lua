...
CreateConVar("ttt2_occul_fire_radius", 500, {FCVAR_ARCHIVE, FCVAR_NOTIFY, FCVAR_REPLICATED})
CreateConVar("ttt2_occul_fire_damagescale", 0, {FCVAR_ARCHIVE, FCVAR_NOTIFY, FCVAR_REPLICATED})
...
hook.Add("TTTUlxDynamicRCVars", "ttt2_ulx_dynamic_occultist_convars", function(tbl)
	...
	table.insert(tbl[ROLE_OCCULTIST], {cvar = "ttt2_occul_fire_radius", slider = true, min = 1, max = 500, decimal = 0, desc = "ttt2_occul_fire_radius (def. 500)"})
	table.insert(tbl[ROLE_OCCULTIST], {cvar = "ttt2_occul_fire_damagescale", slider = true, min = 0, max = 1, decimal = 2, desc = "ttt2_occul_fire_damagescale (def. 0)"})
