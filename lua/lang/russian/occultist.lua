...
L[OCCULTIST.name] = "Оккультист"
L["info_popup_" .. OCCULTIST.name] = [[Вы оккультист!
Вы успешно выполнили ритуал. Теперь вы можете вернуться к жизни, когда ваш здоровья упадёт ниже 25ед.
Если вы получите один выстрел, ваш ритуал не подействует.]]
